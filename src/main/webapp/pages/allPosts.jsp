...
<c:forEach var="post" items="${posts}">
	<tr class="post">
		...
		<td style="width: 50px;">
		  ...
		  <div id="joinPost" class="btn btn-primary join" title="" data-placement="top" data-toggle="tooltip" data-original-title="Join"><span class="glyphicon glyphicon-plus"></span></div>
		</td>
	</tr>
</c:forEach>
</table>
